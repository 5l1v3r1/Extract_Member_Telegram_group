...
# Extract_Member_Telegram_group

##### Program features #####
----------------------
- 📌 Are you looking to add a member to your Telegram group?
- 📌 Do you need to collect Telegram accounts?
- 📌 Are you a security expert and need to fetch members of a group?
- 📌 Do you need to add members from one group to another?
- 📌 Do you need to back up your members?
- 📌 Are you looking for a comprehensive telegram bank of groups?
- 📌 We have developed a script for you that you can easily extract all member information such as username, hash, ID number and in less than 5 seconds. 
- 📌 In this tutorial, we will teach you how to execute Linux commands in Windows and how to execute the source.
...
- 🔞 See Training 🎥 https://www.youtube.com/watch?v=toPKFKANAS8&feature=youtu.be  🎥
